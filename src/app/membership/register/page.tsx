      ...
      <div className="relative flex min-h-screen flex-col items-center justify-center px-6 py-16">
        ...
        <div className="mb-10 flex flex-col items-center text-center">
          ...
          <p className="max-w-sm text-sm leading-relaxed text-neutral-500">
            Become a member of Maranatha and unlock exclusive content, events, and community features.
          </p>
        </div>

        {/* ── Register card ── */}
        <div className="relative w-full max-w-2xl overflow-hidden rounded-2xl border border-white/[0.07] bg-[#111111] p-8">
